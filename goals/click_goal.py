...
class ClickGoal(BaseGoal):
    ...
    def _evaluate_planned_click(self, context: GoalContext, planned_interaction: Dict[str, Any]) -> GoalResult:
        ...
        try:
            ...
            if not is_clickable:
                ...
                return self._handle_planned_non_clickable_element(
                    x,
                    y,
                    element_info,
                    planned_interaction,
    ...
    def _handle_planned_non_clickable_element(
        self,
        x: int,
        y: int,
        ...
        """
        Shared handler when the element identified during plan validation is not clickable.
        """
