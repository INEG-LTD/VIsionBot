...
class Browser:
    ...
    def __init__(
        ...
        Args:
            config: Config object with all settings. If not provided, uses defaults.
    ...
    def __enter__(self) -> 'Browser':
        ...
        Example:
            >>> with Browser(config=config) as bot:
    ...
    def execute_mission(
        ...
        Example:
            ...
            bot.start()
            bot.page.goto("https://example.com")
            result = bot.execute_mission("search for python tutorials")
            if result.success:
        ...
        try:
            ...
            # Connect Executor pause callback to Agent
    ...
    def pause_agent(self, message: str = "Paused") -> None:
        ...
        **Thread-safe**: Can be called from any thread while the agent is running.
        ...
        Example:
            ...
            >>> thread.start()
            >>> 
            >>> result = bot.execute_mission("search for jobs")
        """
