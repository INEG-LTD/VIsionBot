...
Executor.register_post_action_callback = register_post_action_callback
...
Executor._trigger_pre_action_hooks = trigger_pre_action_hooks
Executor._trigger_post_action_hooks = trigger_post_action_hooks

# Bind UI feedback methods to Executor class
Executor._confirm_interaction_visual = confirm_interaction_visual
