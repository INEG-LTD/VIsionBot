...
2. Before deciding, cite relevant memory turns that justify your action.
3. Every decision-bearing tool call must include:
   - memory_evidence_turns: exact turn numbers
...
1. Read cited memory turns and extract the facts you are relying on.
2. Ensure your reasoning does not contradict those facts.
3. Never claim "I haven't done X yet" if cited turns show you already did X.
4. If X was already attempted, say: "I already tried X on turns [...], and the outcome was ..."
