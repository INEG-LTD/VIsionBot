"""
SubAgent - Manages sub-agents for multi-tab workflows.
...
class SubAgent:
    ...
    def __init__(
        ...
        controller_factory: Optional[Callable[..., "Agent"]] = None,
        ...
        Args:
            main_bot: Main Browser instance
        ...
        self.sub_agent_controllers: Dict[str, "Agent"] = {}  # agent_id -> Agent
    ...
    def _create_agent_controller(self) -> "Agent":
